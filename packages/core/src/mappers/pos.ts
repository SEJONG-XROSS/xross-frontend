...
import type { ApiPaymentMethod } from '../types/pos-api';
import type { PosTransaction, PosSummaryStats, PaymentMethod } from '../types/pos';
...
export function mapEventToPosTransaction(
  e: EventResponse,
